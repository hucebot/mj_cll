...
LICENSE
Copyright (2024) Enrico Mingo Hoffman
...
template <class T>
inline void compute_d(Eigen::Matrix<T, Eigen::Dynamic, 1> &d, const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>& J, const Eigen::Matrix<T, Eigen::Dynamic, 1>& np)
{
  d = J.adjoint() * np;
}

template <class T>
inline void update_z(Eigen::Matrix<T, Eigen::Dynamic, 1>& z, const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>& J, const Eigen::Matrix<T, Eigen::Dynamic, 1>& d,  int iq)
{
  z = J.rightCols(z.size()-iq) * d.tail(d.size()-iq);
}

template <class T>
inline void update_r(const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>& R, Eigen::Matrix<T, Eigen::Dynamic, 1>& r, const Eigen::Matrix<T, Eigen::Dynamic, 1>& d, int iq)
{
  r.head(iq) = R.topLeftCorner(iq,iq).template triangularView<Upper>().solve(d.head(iq));
}

template <class T>
bool add_constraint(Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>& R, Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>& J, Eigen::Matrix<T, Eigen::Dynamic, 1>& d, int& iq, double& R_norm);

template <class T>
void delete_constraint(Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>& R, Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>& J, VectorXi& A, Eigen::Matrix<T, Eigen::Dynamic, 1>& u,  int p, int& iq, int l);

/* solve_quadprog2 is used when the Cholesky decomposition of the G matrix is precomputed */
template <class T>
double solve_quadprog2(LLT<Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>,Lower> &chol,  double c1, Eigen::Matrix<T, Eigen::Dynamic, 1> & g0,
                      const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> & CE, const Eigen::Matrix<T, Eigen::Dynamic, 1> & ce0,
                      const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> & CI, const Eigen::Matrix<T, Eigen::Dynamic, 1> & ci0,
                      Eigen::Matrix<T, Eigen::Dynamic, 1>& x);

/* solve_quadprog is used for on-demand QP solving */
template <class T>
inline double solve_quadprog(Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> & G,  Eigen::Matrix<T, Eigen::Dynamic, 1> & g0,
                      const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> & CE, const Eigen::Matrix<T, Eigen::Dynamic, 1> & ce0,
                      const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> & CI, const Eigen::Matrix<T, Eigen::Dynamic, 1> & ci0,
                      Eigen::Matrix<T, Eigen::Dynamic, 1>& x){

  LLT<Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>,Lower> chol(G.cols());
  double c1;
...
template <class T>
inline double solve_quadprog2(LLT<Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>,Lower> &chol,  double c1, Eigen::Matrix<T, Eigen::Dynamic, 1> & g0,
                      const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> & CE, const Eigen::Matrix<T, Eigen::Dynamic, 1> & ce0,
                      const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> & CI, const Eigen::Matrix<T, Eigen::Dynamic, 1> & ci0,
                      Eigen::Matrix<T, Eigen::Dynamic, 1>& x)
{
  ...
  int p=CE.cols();
  int m=CI.cols();
  Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> R(g0.size(),g0.size()), J(g0.size(),g0.size());


  Eigen::Matrix<T, Eigen::Dynamic, 1> s(m+p), z(n), r(m + p), d(n),  np(n), u(m + p);
  Eigen::Matrix<T, Eigen::Dynamic, 1> x_old(n), u_old(m + p);
...
template <class T>
inline bool add_constraint(Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>& R, Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>& J, Eigen::Matrix<T, Eigen::Dynamic, 1>& d, int& iq, double& R_norm)
{
 int n=J.rows();
#ifdef TRACE_SOLVER
...
template <class T>
inline void delete_constraint(Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>& R, Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic>& J, VectorXi& A, Eigen::Matrix<T, Eigen::Dynamic, 1>& u,  int p, int& iq, int l)
{
